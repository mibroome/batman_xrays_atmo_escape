...
for Z in [1, 5, 10]:
    for enhancement in [1,4]:
        ...
        profiles_array       = np.load(f'../batman_xrays_atmo_escape/tau_profiles/tau_HD189_{Z}Z_all.npy',
                                    allow_pickle=True)
        ...
        if rank == 0:
            ...
            np.save(f'../copy/transit_profiles/HD189_{Z}Z_shock_enh{enhancement}_fixed.npy',
